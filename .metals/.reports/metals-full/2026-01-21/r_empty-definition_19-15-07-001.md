error id: file://<WORKSPACE>/src/main/scala/OllamaClient.scala:
file://<WORKSPACE>/src/main/scala/OllamaClient.scala
...
offset: 2288
uri: file://<WORKSPACE>/src/main/scala/OllamaClient.scala
text:
```scala
import sttp.client3.*
  ...
  def embed(texts: Vector[String], model: String): Vector[Vector[Float]] =
    if texts.isEmpty then Vector.empty
      ...
      batchResp match
        ...
        final case class ChatReq(model: String, messages: Vecto@@r[ChatMessage], stream: Boolean = false)
